...
// Visible loading state for the Netlify form submissions (contact, service
// request). These are plain native POSTs (no fetch/AJAX) so the page
// navigates away to /thank-you.html on success - this script only needs to
// give the user feedback in the moment between click and navigation, not
// manage success/failure state itself.
(function(){
